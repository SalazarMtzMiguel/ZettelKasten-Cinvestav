...
Los SES contemplan un proceso muy similar a la ingenieria de software tradicional, es decir, las actividades como lo son ingenieria de requerimientos, diseño, implementacion, pruebas, etc.\cite{sommerville2011software} tienen lugar en este marco de trabajo. Para este trabajo unicamente nos enfocamos en el diseño del software \cite{swebok2014}, esto quiere decir que nos vamos a dedicar a entregar artefactos de diseño, nuestros planos del sistema antes de implementar en codigo.
