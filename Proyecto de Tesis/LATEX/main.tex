...
\begin{table}[H]
	...
	\begin{tabular}{p{0.25\textwidth} p{0.65\textwidth}}
		...
		& \textbf{CI3:} Full-text availability with detailed methodology. \\
		& \textbf{IC4:} Focus on software engineering, self-engineering, or self-design. \\
		& \textbf{IC5:} Relevant studies with recent contributions or balanced citation counts. \\[0.2cm]
		\textbf{Exclusion} & \textbf{EC1:} Duplicate publications or multiple versions of the same study. \\
		& \textbf{EC2:} Abstracts, poster papers, or incomplete documents. \\
		& \textbf{EC3:} studies outside the software engineering domain. \\
		& \textbf{EC4:} Works lacking methodological detail or scientific rigor. \\
		\bottomrule
	\end{tabular}
\end{table}
