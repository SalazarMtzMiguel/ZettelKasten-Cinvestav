 ...
 \shorthandoff{"}
  \begin{table}[H]
 	...
 	\begin{tabular}{|@{} p{0.2\textwidth} | p{0.75\textwidth} @{}|}
 		...
 		11. Self/Auto-Data Structure Design & ("self-data structure design" OR "auto-data structure design" OR "autonomous data structure" OR "self-optimizing data structure*") \\ \hline
