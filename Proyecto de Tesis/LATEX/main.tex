...
Una ontología es una especificación formal y explícita de un dominio: define conceptos, relaciones, individuos, axiomas y restricciones para que el conocimiento pueda ser compartido, reutilizado y procesado por máquinas \cite{}.
...
El trabajo de \cite{duran2026seleccion} une estos temas, para lograr la seleccion automatica de algoritmos,
