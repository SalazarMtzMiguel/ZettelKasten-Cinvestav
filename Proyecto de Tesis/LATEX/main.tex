...
Para dar solucion a este problema, se empleo la metodologia de prometheus, para poder diseñar y brindar un sistema multiagente con un flujo de trabajo determinado y una descripcion de caja blanaca del agente de algoritmos, evidentemente  lo ideal es que todos los agentes sean de caja blanca pero esta fuera del alcance de este trabajo.
